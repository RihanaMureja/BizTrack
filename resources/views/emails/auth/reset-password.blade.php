...
<head>
    ...
    <title>Reset your BizTrack password</title>
</head>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="background:#006b3f;padding:26px 32px;color:#ffffff;">
                                        <p style="margin:0 0 8px;font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#bff0d6;">Password security</p>
                                        <h1 style="margin:0;font-size:26px;line-height:1.25;font-weight:800;">Reset your BizTrack password</h1>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:32px;">
                                        ...
                                        <p style="margin:0 0 20px;font-size:15px;line-height:1.7;color:#40544b;">
                                            We received a request to reset the password for your BizTrack account. Use the secure button below to create a new password and get back to your workspace.
                                        </p>

                                        <table role="presentation" cellspacing="0" cellpadding="0" style="margin:28px 0;">
                                            <tr>
                                                <td style="border-radius:999px;background:#008f55;">
                                                    <a href="{{ $resetUrl }}" style="display:inline-block;padding:14px 24px;border-radius:999px;color:#ffffff;font-size:15px;font-weight:700;text-decoration:none;">
                                                        Reset password
                                                    </a>
                                                </td>
                                            </tr>
                                        ...
                                        <div style="margin:0 0 22px;padding:16px 18px;border-radius:16px;background:#eef8f2;border:1px solid #d7eee0;">
                                            <p style="margin:0;font-size:14px;line-height:1.6;color:#24483a;">
                                                This password reset link expires in <strong>{{ $expiresIn }} minutes</strong>. If you did not request this, you can safely ignore this email and your password will remain unchanged.
                                            </p>
                                        </div>
                                        ...
                                        <p style="margin:0;word-break:break-all;font-size:13px;line-height:1.6;">
                                            <a href="{{ $resetUrl }}" style="color:#006b3f;text-decoration:underline;">{{ $resetUrl }}</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td align="center" style="padding:22px 20px 0;">
                            <p style="margin:0;font-size:12px;line-height:1.6;color:#71837b;">
                                BizTrack helps business owners manage sales, inventory, payments, customers, and reports from one secure workspace.
                            </p>
