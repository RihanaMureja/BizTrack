...
export default function Checkout({
    ...
    const customerDiscount =
        selectedCustomer && Number(selectedCustomer.default_discount) > 0
            ? Math.min(
                  subtotal + tax,
                  (subtotal * Number(selectedCustomer.default_discount)) / 100,
              )
            : 0;
    const total = Math.max(
        0,
        subtotal + tax - manualDiscount - customerDiscount,
    );
                            ...
                            <div className="space-y-2 border-t pt-3 text-sm">
                                ...
                                {customerDiscount > 0 && (
                                    <div className="flex justify-between">
                                        ...
                                        <span>
                                            -{customerDiscount.toFixed(2)} ETB
                                        </span>
                                    </div>
                                )}
