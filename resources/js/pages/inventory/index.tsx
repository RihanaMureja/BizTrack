...
function RestockForm({
    ...
    const restockDate = todayDateInput();
        ...
        <form onSubmit={submit} className="grid gap-4">
            <div>
                ...
                <p className="text-sm text-muted-foreground">
                    Current stock: {item.available_stock} units
                </p>
            </div>
            <div className="grid gap-2">
                <Label htmlFor="restock_quantity">Quantity</Label>
                <Input
                    id="restock_quantity"
                    type="number"
                    min="1"
            ...
            <div className="grid gap-2">
                ...
                <Input
                    ...
                    onChange={(event) =>
                        form.setData('unit_cost', event.target.value)
                    }
                    placeholder="0.00"
                />
            ...
            <div className="grid gap-2">
                ...
                />
                <p className="text-xs text-muted-foreground">
                    Select expiry date. Leave empty if the product does not
                    expire.
                </p>
            ...
            <div className="grid gap-2">
                ...
                <Input
                    ...
                    placeholder="Supplier, delivery note, or reason"
                />
            ...
            render: (item) => (
                <div className="flex justify-end gap-2">
                    ...
                    <Button type="button" variant="outline" size="icon" asChild>
                        <Link
                            href={`/inventory/${item.id}/batches`}
                            aria-label={`View ${item.product.name} batches`}
                        >
                    ...
                    <Button type="button" variant="outline" size="icon" asChild>
                        <Link
                            ...
                            aria-label={`View ${item.product.name} history`}
                        >
                ...
                {!inventory ? (
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <DataTable
                            ...
                            data={inventory.data}
                            rowKey={(item) => item.id}
                            emptyMessage="No inventory records found. Products create inventory records automatically."
                        />
                        <Pagination
