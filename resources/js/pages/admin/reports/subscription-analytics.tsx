...
import { AdminBarPanel, AdminDonutPanel, AdminRankedBars } from '@/components/admin/admin-analytics';
...
type Props = { report: { title: string; summary: SummaryPoint[]; chart: ChartPoint[]; revenueChart: ChartPoint[]; assignmentMix: AdminPoint[]; rows: AnalyticsRow[] } };
        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 lg:p-6">
                ...
                <div className="grid gap-4 xl:grid-cols-[minmax(0,1.2fr)_minmax(20rem,0.8fr)]">
                    <AdminBarPanel
                        title={report.title}
                        description="Businesses assigned per plan."
                        data={report.chart}
                        icon={CreditCard}
                    />
                    <AdminDonutPanel
                        title="Assignment coverage"
                        description="How many businesses have a plan compared with those still unassigned."
                        data={report.assignmentMix}
                    />
                </div>

                <AdminRankedBars
                    title="Recurring value by plan"
                    description="Estimated monthly value generated by each subscription plan."
