...
export default function BusinessRolesIndex({
    roles,
    permissions,
    filters,
}: Props) {
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                Create custom employee roles and decide which
                ...
                {roles ? (
                    <section className="rounded-md border bg-card p-4 shadow-sm">
                        <DataTable
                            ...
                            data={roles.data}
                            rowKey={(role) => role.id}
                            emptyMessage="No employee roles yet."
                        />
                        <div className="mt-4">
                            <Pagination
                                links={roles.links}
                    ...
                    <section className="rounded-md border bg-card p-5 text-sm text-muted-foreground shadow-sm">
                        Create your business profile before managing employee
                        roles.
                    </section>
                )}
            </div>
        ...
        <form onSubmit={submit} className="grid gap-5">
            <div className="grid gap-2">
                ...
                <Input
                    ...
                    required
                    placeholder="Manager, Inventory Staff, Accountant..."
                />
