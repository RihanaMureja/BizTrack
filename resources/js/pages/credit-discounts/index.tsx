    ...
    return (
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 lg:p-6">
                <PageHeader
                    icon={BadgePercent}
                    title="Credit & Discounts"
                    description="Manage tiered discount rules and customer credit suggestions in one place."
                    actions={<Button type="button" onClick={() => setCreating(true)}><Plus className="size-4" />New rule</Button>}
                />
