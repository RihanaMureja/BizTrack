...
export default function CreditDiscountIndex({
    discountRules,
    creditProfiles,
}: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 lg:p-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                Manage tiered discount rules and customer credit
                                ...
                                <div className="flex items-start justify-between gap-3">
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-muted-foreground">
                                            Spend {rule.spend_threshold} ETB in
                                            30 days
                                        </p>
                                    </div>
                                    <Badge
                ...
                <section className="grid gap-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Suggestions are calculated from purchase volume,
                            payment punctuality, average order value, and
                            customer tenure. The customer's credit limit remains
                            the owner override.
                        </p>
                    </div>
                    <div className="grid gap-3 xl:grid-cols-2">
                        {creditProfiles.length === 0 && (
                            <div className="rounded-md border border-dashed p-8 text-center text-sm text-muted-foreground xl:col-span-2">
                                Credit suggestions will appear after customers
                                are created and sales history exists.
                            </div>
                        )}
